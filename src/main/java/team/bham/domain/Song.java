...
public class Song implements Serializable {
    ...
    public Set<PlaylistStats> getEnergeticPlaylistStats() {
        return this.energeticPlaylistStats;
    }

    public void setEnergeticPlaylistStats(Set<PlaylistStats> playlistStats) {
        if (this.energeticPlaylistStats != null) {
            this.energeticPlaylistStats.forEach(i -> i.setEnergeticSong(null));
        }
        if (playlistStats != null) {
            playlistStats.forEach(i -> i.setEnergeticSong(this));
        }
        this.energeticPlaylistStats = playlistStats;
    }

    public Song energeticPlaylistStats(Set<PlaylistStats> playlistStats) {
        this.setEnergeticPlaylistStats(playlistStats);
        return this;
    }

    public Song addEnergeticPlaylistStats(PlaylistStats playlistStats) {
        this.energeticPlaylistStats.add(playlistStats);
        playlistStats.setEnergeticSong(this);
        return this;
    }

    public Song removeEnergeticPlaylistStats(PlaylistStats playlistStats) {
        this.energeticPlaylistStats.remove(playlistStats);
        playlistStats.setEnergeticSong(null);
        return this;
    }
