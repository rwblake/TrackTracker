...
import { EntityArrayResponseType, FriendRequestService } from '../service/friend-request.service';
...
export class FriendRequestComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFriendRequest): number => this.friendRequestService.getFriendRequestIdentifier(item);
