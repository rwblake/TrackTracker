...
public class PlaylistStats implements Serializable {
    ...
    public Song getFastestSong() {
        return this.fastestSong;
    }

    public void setFastestSong(Song song) {
        this.fastestSong = song;
    }

    public PlaylistStats fastestSong(Song song) {
        this.setFastestSong(song);
        return this;
    }
