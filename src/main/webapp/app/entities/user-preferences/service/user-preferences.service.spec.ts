...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../user-preferences.test-samples';

import { UserPreferencesService } from './user-preferences.service';

const requireRestSample: IUserPreferences = {
...
describe('UserPreferences Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a UserPreferences', () => {
      ...
      const userPreferences = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(userPreferences).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a UserPreferences', () => {
      const userPreferences = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(userPreferences).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addUserPreferencesToCollectionIfMissing', () => {
      it('should add a UserPreferences to an empty array', () => {
        const userPreferences: IUserPreferences = sampleWithRequiredData;
      ...
      it("should add a UserPreferences to an array that doesn't contain it", () => {
        const userPreferences: IUserPreferences = sampleWithRequiredData;
        const userPreferencesCollection: IUserPreferences[] = [sampleWithPartialData];
        expectedResult = service.addUserPreferencesToCollectionIfMissing(userPreferencesCollection, userPreferences);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(userPreferences);
      });
      ...
      it('should add only unique UserPreferences to an array', () => {
        const userPreferencesArray: IUserPreferences[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const userPreferencesCollection: IUserPreferences[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const userPreferences: IUserPreferences = sampleWithRequiredData;
        const userPreferences2: IUserPreferences = sampleWithPartialData;
    ...
    describe('compareUserPreferences', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareUserPreferences(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareUserPreferences(entity1, entity2);
        const compareResult2 = service.compareUserPreferences(entity2, entity1);
