...
describe('PlaylistStats Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Song query and add missing value', () => {
      ...
      const energeticSong: ISong = { id: 34337 };
      playlistStats.energeticSong = energeticSong;
      ...
      const additionalSongs = [happiestSong, energeticSong, sumsUpSong, anonmalousSong];
    ...
    it('Should update editForm', () => {
      ...
      playlistStats.happiestSong = happiestSong;
      const energeticSong: ISong = { id: 65168 };
      playlistStats.energeticSong = energeticSong;
      ...
      expect(comp.songsSharedCollection).toContain(energeticSong);
